...
public class DeliveryAddress extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.group.kafka.inventory.domain.DeliveryAddress.Builder newBuilder() {
    return new com.group.kafka.inventory.domain.DeliveryAddress.Builder();
  }
   ...
   * @return A new DeliveryAddress RecordBuilder
   */
  public static com.group.kafka.inventory.domain.DeliveryAddress.Builder newBuilder(com.group.kafka.inventory.domain.DeliveryAddress.Builder other) {
    if (other == null) {
      return new com.group.kafka.inventory.domain.DeliveryAddress.Builder();
    } else {
      return new com.group.kafka.inventory.domain.DeliveryAddress.Builder(other);
    }
  }
   ...
   * @return A new DeliveryAddress RecordBuilder
   */
  public static com.group.kafka.inventory.domain.DeliveryAddress.Builder newBuilder(com.group.kafka.inventory.domain.DeliveryAddress other) {
    if (other == null) {
      return new com.group.kafka.inventory.domain.DeliveryAddress.Builder();
    } else {
      return new com.group.kafka.inventory.domain.DeliveryAddress.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DeliveryAddress>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.group.kafka.inventory.domain.DeliveryAddress.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.group.kafka.inventory.domain.DeliveryAddress other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.AddressLine)) {
        this.AddressLine = data().deepCopy(fields()[0].schema(), other.AddressLine);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.DeliveryAddress.Builder setAddressLine(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.DeliveryAddress.Builder clearAddressLine() {
      AddressLine = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.DeliveryAddress.Builder setCity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.DeliveryAddress.Builder clearCity() {
      City = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.DeliveryAddress.Builder setState(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.DeliveryAddress.Builder clearState() {
      State = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.DeliveryAddress.Builder setPinCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.DeliveryAddress.Builder clearPinCode() {
      PinCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.DeliveryAddress.Builder setContactNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.DeliveryAddress.Builder clearContactNumber() {
      ContactNumber = null;
