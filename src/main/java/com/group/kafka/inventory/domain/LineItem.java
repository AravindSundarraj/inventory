...
public class LineItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public LineItem(java.lang.CharSequence ItemCode, java.lang.CharSequence ItemDescription, java.lang.Double ItemPrice, java.lang.Integer ItemQty, java.lang.CharSequence TotalValue) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: TotalValue = (java.lang.CharSequence)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static com.group.kafka.inventory.domain.LineItem.Builder newBuilder() {
    return new com.group.kafka.inventory.domain.LineItem.Builder();
  }
   ...
   * @return A new LineItem RecordBuilder
   */
  public static com.group.kafka.inventory.domain.LineItem.Builder newBuilder(com.group.kafka.inventory.domain.LineItem.Builder other) {
    if (other == null) {
      return new com.group.kafka.inventory.domain.LineItem.Builder();
    } else {
      return new com.group.kafka.inventory.domain.LineItem.Builder(other);
    }
  }
   ...
   * @return A new LineItem RecordBuilder
   */
  public static com.group.kafka.inventory.domain.LineItem.Builder newBuilder(com.group.kafka.inventory.domain.LineItem other) {
    if (other == null) {
      return new com.group.kafka.inventory.domain.LineItem.Builder();
    } else {
      return new com.group.kafka.inventory.domain.LineItem.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LineItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.group.kafka.inventory.domain.LineItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.group.kafka.inventory.domain.LineItem other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ItemCode)) {
        this.ItemCode = data().deepCopy(fields()[0].schema(), other.ItemCode);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.LineItem.Builder setItemCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.LineItem.Builder clearItemCode() {
      ItemCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.LineItem.Builder setItemDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.LineItem.Builder clearItemDescription() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.LineItem.Builder setItemPrice(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.LineItem.Builder clearItemPrice() {
      ItemPrice = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.LineItem.Builder setItemQty(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.LineItem.Builder clearItemQty() {
      ItemQty = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.LineItem.Builder setTotalValue(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.group.kafka.inventory.domain.LineItem.Builder clearTotalValue() {
      TotalValue = null;
    ...
    public LineItem build() {
      try {
        ...
        record.TotalValue = fieldSetFlags()[4] ? this.TotalValue : (java.lang.CharSequence) defaultValue(fields()[4]);
        return record;
